...
if __name__ == '__main__':
    ...
    for name in os.listdir():
        if os.path.isdir(name) and not name.startswith('.') and not name.startswith('_'):
            if os.path.exists(os.path.join(name, 'model.py')):
    ...
    settings['val_ihc_path']   = 'data/BCI/val/ihc'
    settings['test_he_path']   = 'data/BCI/test/he'
    settings['test_ihc_path']  = 'data/BCI/test/ihc'
    ###########################################################################
    """
     [ Hyper-parameters & image paths ]
     End
